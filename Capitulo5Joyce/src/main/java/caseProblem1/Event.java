 ...
 */
public class Event {
    public final static int MAX_PRECIO = 35;
    public final static int MIN_PRECIO = 32;
    public final static int EVENTO = 50;
    ...
    private void setTam_evento() {
        if(num_inv >= EVENTO){
            this.costo = num_inv * MIN_PRECIO;
            this.tam_evento = true;
        }else{
            this.costo = num_inv * MAX_PRECIO;
